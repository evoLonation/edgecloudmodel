 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LetExpCSImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LetExpCSImpl#getInExpression <em>In Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LetExpCSImpl extends OCLExpressionCSImpl implements LetExpCS
{
  ...
  {
    return ECModelPackage.Literals.LET_EXP_CS;
  }
  ...
  public EList<VariableDeclarationCS> getVariable()
  {
    if (variable == null)
    {
      variable = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this, ECModelPackage.LET_EXP_CS__VARIABLE);
    }
    return variable;
  }
  ...
  public NotificationChain basicSetInExpression(OCLExpressionCS newInExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.LET_EXP_CS__IN_EXPRESSION, oldInExpression, newInExpression);
  ...
  public void setInExpression(OCLExpressionCS newInExpression)
  {
    if (newInExpression != inExpression)
    {
      ...
      if (inExpression != null)
        msgs = ((InternalEObject)inExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.LET_EXP_CS__IN_EXPRESSION, null, msgs);
      if (newInExpression != null)
        msgs = ((InternalEObject)newInExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.LET_EXP_CS__IN_EXPRESSION, null, msgs);
      msgs = basicSetInExpression(newInExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.LET_EXP_CS__IN_EXPRESSION, newInExpression, newInExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.LET_EXP_CS__VARIABLE:
        return ((InternalEList<?>)getVariable()).basicRemove(otherEnd, msgs);
      case ECModelPackage.LET_EXP_CS__IN_EXPRESSION:
