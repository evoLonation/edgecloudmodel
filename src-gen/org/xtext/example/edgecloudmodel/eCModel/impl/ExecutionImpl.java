 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ExecutionImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ExecutionImpl#getStart <em>Start</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ExecutionImpl#getEnd <em>End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExecutionImpl extends MultiEndImpl implements Execution
{
  ...
  {
    return ECModelPackage.Literals.EXECUTION;
  }
    ...
    if (owner != null && owner.eIsProxy())
    {
      ...
      if (owner != oldOwner)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.EXECUTION__OWNER, oldOwner, owner));
      }
    }
    return owner;
  }
  ...
  public void setOwner(Participant newOwner)
  {
    ...
    owner = newOwner;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.EXECUTION__OWNER, oldOwner, owner));
  }
  ...
  public ExecutionEnd getStart()
  {
    if (start != null && start.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.EXECUTION__START, oldStart, start));
      }
    }
    return start;
  }
  ...
  public void setStart(ExecutionEnd newStart)
  {
    ...
    start = newStart;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.EXECUTION__START, oldStart, start));
  }
  ...
  public ExecutionEnd getEnd()
  {
    if (end != null && end.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.EXECUTION__END, oldEnd, end));
      }
    }
    return end;
  }
  ...
  public void setEnd(ExecutionEnd newEnd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.EXECUTION__END, oldEnd, end));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.EXECUTION__OWNER:
        if (resolve) return getOwner();
        return basicGetOwner();
      case ECModelPackage.EXECUTION__START:
        if (resolve) return getStart();
        return basicGetStart();
      case ECModelPackage.EXECUTION__END:
