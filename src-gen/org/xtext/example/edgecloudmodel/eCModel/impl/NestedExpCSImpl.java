 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.NestedExpCSImpl#getNestedExpression <em>Nested Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedExpCSImpl extends OCLExpressionCSImpl implements NestedExpCS
{
  ...
  {
    return ECModelPackage.Literals.NESTED_EXP_CS;
  }
  ...
  public NotificationChain basicSetNestedExpression(OCLExpressionCS newNestedExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.NESTED_EXP_CS__NESTED_EXPRESSION, oldNestedExpression, newNestedExpression);
  ...
  public void setNestedExpression(OCLExpressionCS newNestedExpression)
  {
    if (newNestedExpression != nestedExpression)
    {
      ...
      if (nestedExpression != null)
        msgs = ((InternalEObject)nestedExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.NESTED_EXP_CS__NESTED_EXPRESSION, null, msgs);
      if (newNestedExpression != null)
        msgs = ((InternalEObject)newNestedExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.NESTED_EXP_CS__NESTED_EXPRESSION, null, msgs);
      msgs = basicSetNestedExpression(newNestedExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.NESTED_EXP_CS__NESTED_EXPRESSION, newNestedExpression, newNestedExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.NESTED_EXP_CS__NESTED_EXPRESSION:
