 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getParticipants <em>Participants</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getMessages <em>Messages</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getExecutions <em>Executions</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getCombinedFragments <em>Combined Fragments</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.InteractionImpl#getEnds <em>Ends</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionImpl extends MinimalEObjectImpl.Container implements Interaction
{
  ...
  {
    return ECModelPackage.Literals.INTERACTION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.INTERACTION__NAME, oldName, name));
  }
  ...
  public EList<Participant> getParticipants()
  {
    ...
    {
      participants = new EObjectResolvingEList<Participant>(Participant.class, this, ECModelPackage.INTERACTION__PARTICIPANTS);
    }
    return participants;
  }
  ...
  public EList<Message> getMessages()
  {
    if (messages == null)
    {
      messages = new EObjectContainmentEList<Message>(Message.class, this, ECModelPackage.INTERACTION__MESSAGES);
    }
    return messages;
  }
  ...
  public EList<Execution> getExecutions()
  {
    if (executions == null)
    {
      executions = new EObjectContainmentEList<Execution>(Execution.class, this, ECModelPackage.INTERACTION__EXECUTIONS);
    }
    return executions;
  }
  ...
  public EList<CombinedFragment> getCombinedFragments()
  {
    ...
    {
      combinedFragments = new EObjectContainmentEList<CombinedFragment>(CombinedFragment.class, this, ECModelPackage.INTERACTION__COMBINED_FRAGMENTS);
    }
  ...
  public EList<AbstractEnd> getEnds()
  {
    if (ends == null)
    {
      ends = new EObjectContainmentEList<AbstractEnd>(AbstractEnd.class, this, ECModelPackage.INTERACTION__ENDS);
    }
    return ends;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.INTERACTION__MESSAGES:
        return ((InternalEList<?>)getMessages()).basicRemove(otherEnd, msgs);
      case ECModelPackage.INTERACTION__EXECUTIONS:
        return ((InternalEList<?>)getExecutions()).basicRemove(otherEnd, msgs);
      case ECModelPackage.INTERACTION__COMBINED_FRAGMENTS:
        return ((InternalEList<?>)getCombinedFragments()).basicRemove(otherEnd, msgs);
      case ECModelPackage.INTERACTION__ENDS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.INTERACTION__NAME:
        return getName();
      case ECModelPackage.INTERACTION__PARTICIPANTS:
