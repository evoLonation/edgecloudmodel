 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ServiceImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ServiceImpl#getTemp_property <em>Temp property</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ServiceImpl#getWorkflow <em>Workflow</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ServiceImpl#getInvariance <em>Invariance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceImpl extends ParticipantImpl implements Service
{
  ...
  {
    return ECModelPackage.Literals.SERVICE;
  }
  ...
  public EList<Operation> getOperation()
  {
    if (operation == null)
    {
      operation = new EObjectContainmentEList<Operation>(Operation.class, this, ECModelPackage.SERVICE__OPERATION);
    }
    return operation;
  }
  ...
  public EList<Attribute> getTemp_property()
  {
    ...
    {
      temp_property = new EObjectContainmentEList<Attribute>(Attribute.class, this, ECModelPackage.SERVICE__TEMP_PROPERTY);
    }
  ...
  public EList<Workflow> getWorkflow()
  {
    if (workflow == null)
    {
      workflow = new EObjectResolvingEList<Workflow>(Workflow.class, this, ECModelPackage.SERVICE__WORKFLOW);
    }
    return workflow;
  }
  ...
  public EList<Invariance> getInvariance()
  {
    if (invariance == null)
    {
      invariance = new EObjectContainmentEList<Invariance>(Invariance.class, this, ECModelPackage.SERVICE__INVARIANCE);
    }
    return invariance;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.SERVICE__OPERATION:
        return ((InternalEList<?>)getOperation()).basicRemove(otherEnd, msgs);
      case ECModelPackage.SERVICE__TEMP_PROPERTY:
        return ((InternalEList<?>)getTemp_property()).basicRemove(otherEnd, msgs);
      case ECModelPackage.SERVICE__INVARIANCE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ECModelPackage.SERVICE__WORKFLOW:
        return getWorkflow();
      case ECModelPackage.SERVICE__INVARIANCE:
