 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.IteratorExpCSImpl#getObjectCall <em>Object Call</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.IteratorExpCSImpl#getSimpleCall <em>Simple Call</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.IteratorExpCSImpl#getIterator <em>Iterator</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.IteratorExpCSImpl#getVaribles <em>Varibles</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.IteratorExpCSImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorExpCSImpl extends LoopExpCSImpl implements IteratorExpCS
{
  ...
  {
    return ECModelPackage.Literals.ITERATOR_EXP_CS;
  }
  ...
  public NotificationChain basicSetObjectCall(FeatureCallExpCS newObjectCall, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__OBJECT_CALL, oldObjectCall, newObjectCall);
  ...
  public void setObjectCall(FeatureCallExpCS newObjectCall)
  {
    if (newObjectCall != objectCall)
    {
      ...
      if (objectCall != null)
        msgs = ((InternalEObject)objectCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.ITERATOR_EXP_CS__OBJECT_CALL, null, msgs);
      if (newObjectCall != null)
        msgs = ((InternalEObject)newObjectCall).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.ITERATOR_EXP_CS__OBJECT_CALL, null, msgs);
      msgs = basicSetObjectCall(newObjectCall, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__OBJECT_CALL, newObjectCall, newObjectCall));
  }
  ...
  public void setSimpleCall(String newSimpleCall)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__SIMPLE_CALL, oldSimpleCall, simpleCall));
  }
  ...
  public void setIterator(String newIterator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__ITERATOR, oldIterator, iterator));
  }
  ...
  public EList<VariableDeclarationCS> getVaribles()
  {
    if (varibles == null)
    {
      varibles = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this, ECModelPackage.ITERATOR_EXP_CS__VARIBLES);
    }
    return varibles;
  }
  ...
  public NotificationChain basicSetExp(OCLExpressionCS newExp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__EXP, oldExp, newExp);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExp(OCLExpressionCS newExp)
  {
    if (newExp != exp)
    {
      NotificationChain msgs = null;
      if (exp != null)
        msgs = ((InternalEObject)exp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.ITERATOR_EXP_CS__EXP, null, msgs);
      if (newExp != null)
        msgs = ((InternalEObject)newExp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.ITERATOR_EXP_CS__EXP, null, msgs);
      msgs = basicSetExp(newExp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.ITERATOR_EXP_CS__EXP, newExp, newExp));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.ITERATOR_EXP_CS__OBJECT_CALL:
        return basicSetObjectCall(null, msgs);
      case ECModelPackage.ITERATOR_EXP_CS__VARIBLES:
        return ((InternalEList<?>)getVaribles()).basicRemove(otherEnd, msgs);
      case ECModelPackage.ITERATOR_EXP_CS__EXP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ECModelPackage.ITERATOR_EXP_CS__SIMPLE_CALL:
        return getSimpleCall();
      case ECModelPackage.ITERATOR_EXP_CS__ITERATOR:
        return getIterator();
      case ECModelPackage.ITERATOR_EXP_CS__VARIBLES:
        return getVaribles();
      case ECModelPackage.ITERATOR_EXP_CS__EXP:
