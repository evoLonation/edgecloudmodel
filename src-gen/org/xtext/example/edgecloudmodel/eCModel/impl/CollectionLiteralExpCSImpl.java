 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.CollectionLiteralExpCSImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.CollectionLiteralExpCSImpl#getPart <em>Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionLiteralExpCSImpl extends LiteralExpCSImpl implements CollectionLiteralExpCS
{
  ...
  {
    return ECModelPackage.Literals.COLLECTION_LITERAL_EXP_CS;
  }
  ...
  public NotificationChain basicSetKind(CollectionTypeIdentifierCS newKind, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.COLLECTION_LITERAL_EXP_CS__KIND, oldKind, newKind);
  ...
  public void setKind(CollectionTypeIdentifierCS newKind)
  {
    if (newKind != kind)
    {
      ...
      if (kind != null)
        msgs = ((InternalEObject)kind).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.COLLECTION_LITERAL_EXP_CS__KIND, null, msgs);
      if (newKind != null)
        msgs = ((InternalEObject)newKind).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.COLLECTION_LITERAL_EXP_CS__KIND, null, msgs);
      msgs = basicSetKind(newKind, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.COLLECTION_LITERAL_EXP_CS__KIND, newKind, newKind));
  }
  ...
  public EList<CollectionLiteralPartCS> getPart()
  {
    if (part == null)
    {
      part = new EObjectContainmentEList<CollectionLiteralPartCS>(CollectionLiteralPartCS.class, this, ECModelPackage.COLLECTION_LITERAL_EXP_CS__PART);
    }
    return part;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.COLLECTION_LITERAL_EXP_CS__KIND:
        return basicSetKind(null, msgs);
      case ECModelPackage.COLLECTION_LITERAL_EXP_CS__PART:
