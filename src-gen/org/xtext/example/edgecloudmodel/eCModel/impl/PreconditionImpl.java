 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.PreconditionImpl#getOclexp <em>Oclexp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreconditionImpl extends MinimalEObjectImpl.Container implements Precondition
{
  ...
  {
    return ECModelPackage.Literals.PRECONDITION;
  }
  ...
  public NotificationChain basicSetOclexp(OCLExpressionCS newOclexp, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.PRECONDITION__OCLEXP, oldOclexp, newOclexp);
  ...
  public void setOclexp(OCLExpressionCS newOclexp)
  {
    if (newOclexp != oclexp)
    {
      ...
      if (oclexp != null)
        msgs = ((InternalEObject)oclexp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.PRECONDITION__OCLEXP, null, msgs);
      if (newOclexp != null)
        msgs = ((InternalEObject)newOclexp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.PRECONDITION__OCLEXP, null, msgs);
      msgs = basicSetOclexp(newOclexp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.PRECONDITION__OCLEXP, newOclexp, newOclexp));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.PRECONDITION__OCLEXP:
