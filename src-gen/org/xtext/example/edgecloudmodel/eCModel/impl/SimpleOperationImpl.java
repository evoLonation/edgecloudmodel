 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.SimpleOperationImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimpleOperationImpl extends WorkflowExpImpl implements SimpleOperation
{
  ...
  {
    return ECModelPackage.Literals.SIMPLE_OPERATION;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.SIMPLE_OPERATION__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(Operation newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.SIMPLE_OPERATION__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.SIMPLE_OPERATION__REF:
