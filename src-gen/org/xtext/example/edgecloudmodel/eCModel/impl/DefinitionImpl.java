 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.DefinitionImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionImpl extends MinimalEObjectImpl.Container implements Definition
{
  ...
  {
    return ECModelPackage.Literals.DEFINITION;
  }
  ...
  public EList<VariableDeclarationCS> getVariable()
  {
    if (variable == null)
    {
      variable = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this, ECModelPackage.DEFINITION__VARIABLE);
    }
    return variable;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.DEFINITION__VARIABLE:
