 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LoopExpImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LoopExpImpl#getExps <em>Exps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoopExpImpl extends JoinExpImpl implements LoopExp
{
  ...
  {
    return ECModelPackage.Literals.LOOP_EXP;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.LOOP_EXP__NAME, oldName, name));
  }
  ...
  public EList<WorkflowExp> getExps()
  {
    if (exps == null)
    {
      exps = new EObjectContainmentEList<WorkflowExp>(WorkflowExp.class, this, ECModelPackage.LOOP_EXP__EXPS);
    }
    return exps;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.LOOP_EXP__EXPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.LOOP_EXP__NAME:
        return getName();
      case ECModelPackage.LOOP_EXP__EXPS:
        return getExps();
    }
