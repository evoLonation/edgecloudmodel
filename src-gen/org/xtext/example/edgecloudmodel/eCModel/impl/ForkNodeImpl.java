 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.ForkNodeImpl#getStartlinks <em>Startlinks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkNodeImpl extends WorkflowExpImpl implements ForkNode
{
  ...
  {
    return ECModelPackage.Literals.FORK_NODE;
  }
  ...
  public EList<JoinExp> getStartlinks()
  {
    if (startlinks == null)
    {
      startlinks = new EObjectResolvingEList<JoinExp>(JoinExp.class, this, ECModelPackage.FORK_NODE__STARTLINKS);
    }
    return startlinks;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.FORK_NODE__STARTLINKS:
