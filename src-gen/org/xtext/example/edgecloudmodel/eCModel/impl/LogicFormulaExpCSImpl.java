 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LogicFormulaExpCSImpl#getAtomicexp <em>Atomicexp</em>}</li>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.LogicFormulaExpCSImpl#getConnector <em>Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicFormulaExpCSImpl extends OCLExpressionCSImpl implements LogicFormulaExpCS
{
  ...
  {
    return ECModelPackage.Literals.LOGIC_FORMULA_EXP_CS;
  }
  ...
  public EList<EObject> getAtomicexp()
  {
    if (atomicexp == null)
    {
      atomicexp = new EObjectContainmentEList<EObject>(EObject.class, this, ECModelPackage.LOGIC_FORMULA_EXP_CS__ATOMICEXP);
    }
    return atomicexp;
  }
  ...
  public EList<String> getConnector()
  {
    if (connector == null)
    {
      connector = new EDataTypeEList<String>(String.class, this, ECModelPackage.LOGIC_FORMULA_EXP_CS__CONNECTOR);
    }
    return connector;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.LOGIC_FORMULA_EXP_CS__ATOMICEXP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.LOGIC_FORMULA_EXP_CS__ATOMICEXP:
        return getAtomicexp();
      case ECModelPackage.LOGIC_FORMULA_EXP_CS__CONNECTOR:
        return getConnector();
    }
