 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.CallMessageImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallMessageImpl extends MessageImpl implements CallMessage
{
  ...
  {
    return ECModelPackage.Literals.CALL_MESSAGE;
  }
    ...
    if (op != null && op.eIsProxy())
    {
      ...
      if (op != oldOp)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.CALL_MESSAGE__OP, oldOp, op));
      }
    }
    return op;
  }
  ...
  public void setOp(Operation newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.CALL_MESSAGE__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.CALL_MESSAGE__OP:
