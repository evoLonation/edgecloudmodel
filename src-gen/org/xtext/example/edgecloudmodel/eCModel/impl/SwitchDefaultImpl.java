 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.SwitchDefaultImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchDefaultImpl extends MinimalEObjectImpl.Container implements SwitchDefault
{
  ...
  {
    return ECModelPackage.Literals.SWITCH_DEFAULT;
  }
  ...
  public NotificationChain basicSetOp(SimpleOperation newOp, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ECModelPackage.SWITCH_DEFAULT__OP, oldOp, newOp);
  ...
  public void setOp(SimpleOperation newOp)
  {
    if (newOp != op)
    {
      ...
      if (op != null)
        msgs = ((InternalEObject)op).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.SWITCH_DEFAULT__OP, null, msgs);
      if (newOp != null)
        msgs = ((InternalEObject)newOp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ECModelPackage.SWITCH_DEFAULT__OP, null, msgs);
      msgs = basicSetOp(newOp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.SWITCH_DEFAULT__OP, newOp, newOp));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ECModelPackage.SWITCH_DEFAULT__OP:
