 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.edgecloudmodel.eCModel.impl.MixEndImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MixEndImpl extends AbstractEndImpl implements MixEnd
{
  ...
  {
    return ECModelPackage.Literals.MIX_END;
  }
    ...
    if (context != null && context.eIsProxy())
    {
      ...
      if (context != oldContext)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ECModelPackage.MIX_END__CONTEXT, oldContext, context));
      }
    }
    return context;
  }
  ...
  public void setContext(MultiEnd newContext)
  {
    ...
    context = newContext;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ECModelPackage.MIX_END__CONTEXT, oldContext, context));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ECModelPackage.MIX_END__CONTEXT:
