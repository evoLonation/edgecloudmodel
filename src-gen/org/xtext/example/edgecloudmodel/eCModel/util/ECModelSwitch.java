 ...
 * @generated
 */
public class ECModelSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ECModelPackage.EXECUTION:
      {
        ...
        if (result == null) result = caseMultiEnd(execution);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.ABSTRACT_END:
      {
      ...
      case ECModelPackage.MESSAGE_END:
      {
        ...
        if (result == null) result = caseMixEnd(messageEnd);
        if (result == null) result = caseAbstractEnd(messageEnd);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.MULTI_END:
      {
      ...
      case ECModelPackage.EXECUTION_END:
      {
        ...
        if (result == null) result = caseMixEnd(executionEnd);
      ...
      case ECModelPackage.COMBINED_FRAGMENT_END:
      {
        ...
        if (result == null) result = caseMixOpAndCFEnd(combinedFragmentEnd);
        if (result == null) result = caseAbstractEnd(combinedFragmentEnd);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.OPERAND_END:
      {
        ...
        if (result == null) result = caseMixOpAndCFEnd(operandEnd);
        if (result == null) result = caseAbstractEnd(operandEnd);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.ACTOR:
      {
        ...
        if (result == null) result = caseMultiEnd(actor);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.SERVICE:
      {
        ...
        if (result == null) result = caseParticipant(service);
        if (result == null) result = caseMultiEnd(service);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.PARTICIPANT:
      {
        Participant participant = (Participant)theEObject;
        T result = caseParticipant(participant);
        if (result == null) result = caseMultiEnd(participant);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.WORKFLOW_EXP:
      {
      ...
      case ECModelPackage.PARTITION_ACTION:
      {
        ...
        if (result == null) result = caseWorkflowExp(partitionAction);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.JOIN_EXP:
      {
      ...
      case ECModelPackage.ACTIVITY_FINAL:
      {
        ...
        if (result == null) result = caseWorkflowExp(activityFinal);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.INITAL_NODE:
      {
        ...
        if (result == null) result = caseWorkflowExp(initalNode);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.FORK_NODE:
      {
        ...
        if (result == null) result = caseWorkflowExp(forkNode);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.JOIN_NODE:
      {
        ...
        if (result == null) result = caseWorkflowExp(joinNode);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.COMPLEX_OPEARTION:
      {
        ComplexOpeartion complexOpeartion = (ComplexOpeartion)theEObject;
        T result = caseComplexOpeartion(complexOpeartion);
        if (result == null) result = caseWorkflowExp(complexOpeartion);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.SIMPLE_OPERATION:
      {
        ...
        if (result == null) result = caseWorkflowExp(simpleOperation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.LOOP_EXP:
      {
        ...
        if (result == null) result = caseJoinExp(loopExp);
        if (result == null) result = caseComplexOpeartion(loopExp);
        if (result == null) result = caseWorkflowExp(loopExp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.SWITCH_EXP:
      {
        ...
        if (result == null) result = caseJoinExp(switchExp);
        if (result == null) result = caseComplexOpeartion(switchExp);
        if (result == null) result = caseWorkflowExp(switchExp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.OPERATION:
      {
        ...
        if (result == null) result = caseJoinExp(operation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.ENTITY_TYPE:
      {
        ...
        if (result == null) result = caseTypeCS(entityType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.ENUM_ENTITY:
      {
        ...
        if (result == null) result = caseTypeCS(enumEntity);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.OCL_EXPRESSION_CS:
      {
      ...
      case ECModelPackage.NESTED_EXP_CS:
      {
        ...
        if (result == null) result = caseOCLExpressionCS(nestedExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.LOGIC_FORMULA_EXP_CS:
      {
        ...
        if (result == null) result = caseOCLExpressionCS(logicFormulaExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.LEFT_SUB_ATOMIC_EXPRESSION:
      {
      ...
      case ECModelPackage.RIGHT_SUB_ATOMIC_EXPRESSION:
      {
      ...
      case ECModelPackage.CALL_EXP_CS:
      {
        CallExpCS callExpCS = (CallExpCS)theEObject;
        T result = caseCallExpCS(callExpCS);
        if (result == null) result = caseLeftSubAtomicExpression(callExpCS);
        if (result == null) result = caseRightSubAtomicExpression(callExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.LOOP_EXP_CS:
      {
        LoopExpCS loopExpCS = (LoopExpCS)theEObject;
        T result = caseLoopExpCS(loopExpCS);
        if (result == null) result = caseCallExpCS(loopExpCS);
        if (result == null) result = caseLeftSubAtomicExpression(loopExpCS);
        if (result == null) result = caseRightSubAtomicExpression(loopExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.ITERATOR_EXP_CS:
      {
        ...
        if (result == null) result = caseLeftSubAtomicExpression(iteratorExpCS);
        if (result == null) result = caseRightSubAtomicExpression(iteratorExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.FEATURE_CALL_EXP_CS:
      {
        ...
        if (result == null) result = caseLeftSubAtomicExpression(featureCallExpCS);
        if (result == null) result = caseRightSubAtomicExpression(featureCallExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.STANDARD_NAVIGATION_CALL_EXP_CS:
      {
        ...
        if (result == null) result = caseFeatureCallExpCS(standardNavigationCallExpCS);
        if (result == null) result = caseCallExpCS(standardNavigationCallExpCS);
        if (result == null) result = caseLeftSubAtomicExpression(standardNavigationCallExpCS);
        if (result == null) result = caseRightSubAtomicExpression(standardNavigationCallExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.STANDARD_OPERATION_EXP_CS:
      {
        ...
        if (result == null) result = caseFeatureCallExpCS(standardOperationExpCS);
        if (result == null) result = caseCallExpCS(standardOperationExpCS);
        if (result == null) result = caseLeftSubAtomicExpression(standardOperationExpCS);
        if (result == null) result = caseRightSubAtomicExpression(standardOperationExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.PREDEFINE_OP:
      {
      ...
      case ECModelPackage.STANDARD_NONE_PARAMETER_OPERATION:
      {
        ...
        if (result == null) result = casePredefineOp(standardNoneParameterOperation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.STANDARD_PARAMETER_OPERATION:
      {
        ...
        if (result == null) result = casePredefineOp(standardParameterOperation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.STANDARD_DATE_OPERATION:
      {
        ...
        if (result == null) result = casePredefineOp(standardDateOperation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.CLASSIFER_CALL_EXP_CS:
      {
        ...
        if (result == null) result = caseFeatureCallExpCS(classiferCallExpCS);
        if (result == null) result = caseCallExpCS(classiferCallExpCS);
        if (result == null) result = caseLeftSubAtomicExpression(classiferCallExpCS);
        if (result == null) result = caseRightSubAtomicExpression(classiferCallExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.PROPERTY_CALL_EXP_CS:
      {
        ...
        if (result == null) result = caseLeftSubAtomicExpression(propertyCallExpCS);
        if (result == null) result = caseRightSubAtomicExpression(propertyCallExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.OPERATION_CALL_EXP_CS:
      {
        ...
        if (result == null) result = caseLeftSubAtomicExpression(operationCallExpCS);
        if (result == null) result = caseRightSubAtomicExpression(operationCallExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.VARIABLE_EXP_CS:
      {
        ...
        if (result == null) result = caseLeftSubAtomicExpression(variableExpCS);
        if (result == null) result = caseRightSubAtomicExpression(variableExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(literalExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.ENUM_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(enumLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.TUPLE_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(tupleLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ECModelPackage.COLLECTION_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(collectionLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.COLLECTION_LITERAL_PART_CS:
      {
      ...
      case ECModelPackage.COLLECTION_ITEM:
      {
        ...
        if (result == null) result = caseCollectionLiteralPartCS(collectionItem);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.PRIMITIVE_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(primitiveLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.NUMBER_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseOCLExpressionCS(numberLiteralExpCS);
        if (result == null) result = caseRightSubAtomicExpression(numberLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.BOOLEAN_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(booleanLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.STRING_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(stringLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.NULL_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(nullLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.INVALID_LITERAL_EXP_CS:
      {
        ...
        if (result == null) result = caseRightSubAtomicExpression(invalidLiteralExpCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.RESERVED_KEYWORD_CS:
      {
      ...
      case ECModelPackage.COLLECTION_TYPE_IDENTIFIER_CS:
      {
        ...
        if (result == null) result = caseReservedKeywordCS(collectionTypeIdentifierCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.PRIMITIVE_TYPE_CS:
      {
        ...
        if (result == null) result = caseReservedKeywordCS(primitiveTypeCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ECModelPackage.OCL_TYPE_CS:
      {
        ...
        if (result == null) result = caseReservedKeywordCS(oclTypeCS);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
